    ...
    <form action={action} className="space-y-8">
      <section className="space-y-4">
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <TextField name="tradeName" label="Nome fantasia" defaultValue={settings.tradeName} required />
          <TextField name="cnpj" label="CNPJ" defaultValue={settings.cnpj} />
          <TextField name="phone" label="Telefone" defaultValue={settings.phone} />
          <TextField name="email" label="E-mail" defaultValue={settings.email} required type="email" />
        </div>
        <TextField name="address" label="Endereco" defaultValue={settings.address} />
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <ColorField name="lightPrimaryColor" label="Primaria clara" defaultValue={settings.lightPrimaryColor} />
          <ColorField name="lightBackgroundColor" label="Fundo claro" defaultValue={settings.lightBackgroundColor} />
          <ColorField name="lightTextColor" label="Texto claro" defaultValue={settings.lightTextColor} />
          <ColorField name="darkPrimaryColor" label="Primaria escura" defaultValue={settings.darkPrimaryColor} />
          <ColorField name="darkBackgroundColor" label="Fundo escuro" defaultValue={settings.darkBackgroundColor} />
          <ColorField name="darkTextColor" label="Texto escuro" defaultValue={settings.darkTextColor} />
        </div>
      </section>
